README for gather example

I wrote this to verify I understood how to use the gather functionality of the PKO.

This is based on the passthrough example, which implements a loopback
pass through for RGMII/SGMII/XAUI ports. Each port loops every packet
received back out the same port.
